...
if(!$file0){
  $filename0 = "../img/photo/sample.png";
}
if(!$file){
				...
				<div id="header">
					...
					<div class="hader_bg">
						<table class="photobale"align="center">
							<tr><td width="70"></td><td align="left" ><img src="$photo1"class="photo" $style></td><td align="right" >　<img class="photo"src="$photo2" $style alt=""></td><td width="70"></td></tr>
					...
					<div class="kenkou"align="right">
						<p>&#9658 今月の健康状態　体重： $kg kg 血圧： $mmhg mmHg</p>
					</div>
