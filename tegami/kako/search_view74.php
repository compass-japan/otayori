...
<div align="center">
  <div class="kname">
      <?php
      $result = mysql_query("SELECT * FROM complet WHERE name1 = 2017 and name2 = 4",$cn);
      ...
      while($array = mysql_fetch_array($result)) {
       ...
       print '<td align="center"><h2 align="center"><a href="preview3.php?no='.$array["no"].'"target="_top">'.$array["name"]. '様</h2></a></td>';
        $cnt++;
      }
      if ($cnt !== 0) {
        while ($cnt % 6 !== 0) {
