...
<div align="center">
      <?php
      $result = mysql_query("SELECT * FROM complet WHERE name1 = 2018 and name2 = 7",$cn);
      ...
      while($array = mysql_fetch_array($result)) {
       ...
       print '<td align="center" bgcolor="fff8e3" width="160" style="border: 1px solid #bc372b;"><h2><a href="preview3.php?no='.$array["no"].'"target="_top">'.$array["name"]. '</a></h2></td>';
        $cnt++;
      }
      if ($cnt !== 0) {
        while ($cnt % 6 !== 0) {
...
?>
<a href="toshi20.php"><img src="../img/m.png" alt=""></a>
</div>
