...
if(!empty($_POST["name"])){
$result = mysql_query("INSERT INTO preview(name,day,day1,day2,reader,name1,name2,info,yotei,photo0,photo1,photo2,photo3,photo4,photo11,cap1,cap2,cap3,cap4,cap11,kg,mmhg) VALUE(\"$_POST[name]\",\"$_POST[day]\",\"$_POST[day1]\",\"$_POST[day2]\",\"$_POST[reader]\",\"$_POST[name1]\",\"$_POST[name2]\",\"$_POST[info]\",\"$_POST[yotei]\",\"$filename0\",\"$filename\",\"$filename1\",\"$filename2\",\"$filename3\",\"$filename11\",\"$_POST[cap1]\",\"$_POST[cap2]\",\"$_POST[cap3]\",\"$_POST[cap4]\",\"$_POST[kg]\",\"$_POST[mmhg]\")",$cn1);
  }
$no = $_GET["no"];
      ...
      <input type="hidden" name="mmhg" value="$mmhg">
       ...
       <div id="print"><a href="#" onclick="document.s1.submit(); return false;"><img src="../img/back_l.png"></a></div>
          ...
          <Tr>
           ...
           <Td height="400" align="center"><img class="ivent1" src="$photo0"></Td>
           </Tr>
           <Tr>
           <Td height="90" valign="top" align="center"style="font-family :'Yu Gothic',sans-serif;"><Font size="5">$capc</Font></Td>
           </Tr>
           <Tr>
           <Td height="13"colspan="2"></Td>
           </Tr>
            <Tr>
           <Td align="center" border="5"  valign="top" height="4" colspan="2" bgcolor="#63584e"style="font-family :'Yu Gothic',sans-serif; font-size:29px; padding-top:14px;"><Font color="white" ><b>今月の$name 様のご様子</b></Font></Td>
           </Tr>
           </Table>
            ...
            <table $style class="small" width="1100"style="table-layout: fixed;"height="100%">
               <Tr>
               <Td width="500" height="10" align="center" valign="top"><img src="$photo1" class="pt"></Td>
               <Td width="500" height="10" align="center" valign="top"><img src="$photo2" class="pt"></Td>
               </Tr>
               <Tr>
               <Td height="17" valign="top" align="center" valign="top"><Font size="6" color=""style="font-family :'Yu Gothic',sans-serif;" ><b>$cap1</b></Font></Td>
               <Td height="17" valign="top" align="center" valign="top"><Font size="6" color=""style="font-family :'Yu Gothic',sans-serif;" ><b>$cap2</b></Font></Td>
               </Tr>
               <Tr>
               <Td width="500" height="10" align="center" valign="bottom"><img src="$photo3" class="pt1" ></Td>
               <Td width="500" height="10" align="center" valign="bottom"><img src="$photo4" class="pt1"></Td>
               </Tr>
               <Tr>
               <Td height="17" valign="top" align="center"><Font size="6" color=""style="font-family :'Yu Gothic',sans-serif;" ><b>$cap3</b></Font></Td>
               <Td height="17" valign="top" align="center"><Font size="6" color="" style="font-family :'Yu Gothic',sans-serif;"><b>$cap4</b></Font></Td>
               </Tr>
            </table>
          ...
          <table  $style1 class="big" width="1100" height="100%">
                ...
                <Tr>
                 <Td height="55" valign="top" align="center" style="font-family :'Yu Gothic',sans-serif;"><Font size="6" color="" ><b>$cap11</b></Font></Td>
                </Tr>
          </table>
            <table class="kenkoub"  width="1100">
