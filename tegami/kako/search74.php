...
.kenkoub{
  ...
  <?php
    ...
    $result = mysql_query("SELECT * FROM complet WHERE name1 = 2017 and name2 = 4",$cn1);
    $i=0;
    while($row = mysql_fetch_array($result))
    {
      ...
      <input type="hidden" name="mmhg" value="$mmhg">
       ...
       <div id="print"><a href="#" onclick="document.s1.submit(); return false;"><img src="../img/back_l.png"></a></div>
          <Table class="toptable" background="../img/back_spring.jpg" width="1100" height="553"style="border-style:solid;border-width:5px;
          ...
          <Tr>
           ...
           <Tr>
           <Td width="600" height="10" class="titlep"style="font-size:30px;font-family :'Yu Gothic',sans-serif;"><b>$name1 $name2 号</b></Td>
           <Td></Td>
           </Tr>
           <Tr>
           ...
           <Td height="300" align="center"><img class="ivent1" src="$photo0"></Td>
           </Tr>
           <Tr>
           <Td height="190" valign="top" align="center"style="font-family :'Yu Gothic',sans-serif;"><Font size="5" color="BlueViolet" >capc</Font></Td>
           </Tr>
           <Tr>
           ...
           <Td align="center" colspan="2" bgcolor="#63584e"style="font-family :'Yu Gothic',sans-serif;"><Font size="6" color="white" ><b>今月の$name 様のご様子</b></Font></Td>
            ...
            <table $style class="small" width="1100"style="table-layout: fixed;"height="100%">
               ...
               <Tr>
               <Td height="17" valign="top" align="center"><Font size="6" color=""style="font-family :'Yu Gothic',sans-serif;" ><b>$cap1</b></Font></Td>
               <Td height="17" valign="top" align="center"><Font size="6" color=""style="font-family :'Yu Gothic',sans-serif;" ><b>$cap2</b></Font></Td>
               </Tr>
               <Tr>
          ...
          <table  $style1 class="big" width="1100" height="100%">
                ...
                <Tr>
                 <Td height="15" valign="top" align="center" style="font-family :'Yu Gothic',sans-serif;"><Font size="6" color="" ><b>$cap11</b></Font></Td>
                </Tr>
          </table>
            <table class="kenkoub"  width="1100">
               <Tr>
               <Td width="1000" height="12" align="right"style="font-family :'Yu Gothic',sans-serif;">体重：　$km kg 　　血圧：　$mmhg mmHg</Td>
               <Tr rules="none">
               <Td height="10"></Td>
               </Tr>
               <Tr>
