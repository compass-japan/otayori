...
EOM;
		            ...
		            <table class="photobale"align="center" $style>
							...
							<tr><td width="70"></td><td align="left" valign="bottom"><img class="photo"src="$photo3" alt=""
							></td><td align="right" valign="bottom">　<img class="photo"src="$photo4" alt=""></td><cairo_matrix_transform_distance(matrix, dx, dy)																														 width="70"></td></tr>
