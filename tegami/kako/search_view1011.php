...
<h1 align="center">完成者リスト</h1>
	<?php
	$result = mysql_query("SELECT * FROM complet WHERE name1 = 2020 and name2 = 11",$cn);
//      $result = mysql_query("SELECT * FROM otayori WHERE eyar = 2020 and mooth = 11",$cn);
...
//    echo'<h2 align="center"><a href="mletter.php?no='.$row["no"].'">'.$row["name"]. '様</h2></a><br>';
      $i++;
      }
