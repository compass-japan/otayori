...
<html lang="ja">
  ...
  <?php
    ...
    $result = mysql_query("SELECT * FROM complet WHERE name1 = 2020 and name2 = 1",$cn1);
    $i=0;
      ...
      <div id=$BG>
        ...
        <div id="header">
          ...
          <table id="headerInfo">
              ...
              <tr  class="title">習志野台便り<th class="hk1">発行日<br>編集責任者</th><th class="hk2">$day<br>$reader</th></tr>
          </table>
        </div>
          <!--メッセージ及びホーム長写真-->
