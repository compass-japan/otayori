...
<h1 align="center">完成者リスト</h1>
      <?php
      $result = mysql_query("SELECT * FROM complet WHERE name1 = 2019 and name2 = 7",$cn);
      ...
      echo'<h2 align="center"><a href="preview3.php?no='.$row["id"].'"target="_top">'.$row["name"]. '様</h2></a><br>';
