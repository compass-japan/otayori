...
$result = mysql_query("INSERT INTO complet(name,day,day1,day2,reader,name1,name2,info,yotei,cap1,cap2,cap3,cap4,kg,mmhg) VALUE(\"$_POST[name]\",\"$_POST[day]\",\"$_POST[reader]\",\"$_POST[name1]\",\"$_POST[name2]\",\"$_POST[info]\",\"$_POST[yotei]\",\"$_POST[cap1]\",\"$_POST[cap2]\",\"$_POST[cap3]\",\"$_POST[cap4]\",\"$_POST[kg]\",\"$_POST[mmhg]\")",$cn);
      }
?>
<!DOCTYPE html>
<html lang="ja">
...
<h1 align="center">完成者リスト</h1>
      <?php
      $result = mysql_query("SELECT * FROM complet WHERE name1 = 2017 and name2 = 1",$cn);
