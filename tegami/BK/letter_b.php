...
EOM;
			...
			$result5 = mysql_query("SELECT name FROM meibo wehre flg = 0 ",$cn);
			$i=0;
	...
	echo <<<EOM
						...
						<img src="img/photo01.gif" class="mleft-10" alt="画像" onclick="click11();"><input type="text" name="cap11" align="left" size="35" value="$cap11" maxlength="15" placeholder="写真のコメントを入れて下さい"><img src="img/human_icon.png" class="mleft-10"></p><p id="photofile11">
						</div>
						<div class="photo1">
							<h4>
						...
						<div class="photoBox">
							...
							<img src="img/photo01.gif" alt="画像"  class="mleft-10" onclick="click1();"><input type="text" align="left" size="35" name="cap1" maxlength="14" value="$cap1" placeholder="写真のコメントを入れて下さい"><img src="img/human_icon.png" class="mleft-10"><p id="photo_delete1"></p><p id="photofile01"></p>
							<input type="file" name="imgup1"   id="photo_file2" class="photo_file2 delf">
							<img src="img/photo02.gif" alt="画像"  class="mleft-10" onclick="click2();"><input type="text" align="left" size="35" name="cap2" maxlength="14"  value="$cap2" placeholder="写真のコメントを入れて下さい"><img src="img/human_icon.png" class="mleft-10"><p id="photo_file02"></p>
							<input type="file" name="imgup2" id="photo_file3" class="photo_file3 delf">
							<img src="img/photo03.gif" alt="画像"  class="mleft-10" onclick="click3();"><input type="text" align="left" size="35" name="cap3" maxlength="14" value="$cap3" placeholder="写真のコメントを入れて下さい"><img src="img/human_icon.png" class="mleft-10"><p id="photo_file03"></p>
							<input type="file" name="imgup3" id="photo_file4" class="photo_file4 delf">
							<img src="img/photo04.gif" alt="画像" class="mleft-10" onclick="click4();"><input type="text" align="left" size="35"  maxlength="14" name="cap4" value="$cap4" placeholder="写真のコメントを入れて下さい" ><img src="img/human_icon.png" class="mleft-10"><p id="photo_file04"></p>		
						</div>
						<h4>◆健康状態</h4>
						<p>体重：　<input type="text" value="$kg" name="kg" align="left" size="10" style="ime-mode: disabled;" maxlength="3">kg　　
						血圧：　<input type="text" name="mmhg" value="$mmhg" align="left" size="10" style="ime-mode: disabled;" maxlength="8">mmhg</p>
				</div>
			</div>
		</div>
		<div class="bt1">
