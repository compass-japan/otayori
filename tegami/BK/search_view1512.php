...
<html lang="ja">
  ...
  <?php
    ...
    $result = mysql_query("SELECT * FROM complet WHERE name1 = 2025 and name2 = 12",$cn1);
    $i=0;
      ...
      <div id=$BG>
        ...
        <div id="header">
          ...
          <table id="headerInfo">
              ...
              <tr><th class="title">ラヴィーレ習志野台</th><th class="hk1">発行日<br>編集責任者</th><th class="hk2">$day<br>$reader</th></tr>
          </table>
        </div>
          <!--メッセージ及びホーム長写真-->
          ...
          <div class="hader_bg">
            <table class="photobale"align="center">
              <tr><td width="70"></td><td align="left"><img src="$photo1"class="photo"width="300" alt=""></td><td align="right">　<img class="photo"src="$photo2" width="300" alt=""></td><td width="70"></td></tr>
              <tr><td width="70"></td><td class="capv">$cap1</td><td class="capv">$cap2</td><td width="70"></td></tr>
              <tr><td width="70"></td><td align="left"><img class="photo"src="$photo3" width="300" alt=""></td><td  align="right">　<img class="photo"src="$photo4"width="300" alt=""></td><td width="70"></td></tr>
              <tr><td width="70"></td><td class="capv">$cap3</td><td class="capv">$cap4</td><td width="70"></td></tr>
            </table>
          </div>
...
<div id="print"align="center">
      <a href="#" onclick="window.print(); document.s1.submit(); return false;"><img src="../img/familyHistory_print.png"></a>
