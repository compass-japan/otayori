...
<body>
	<form method="post" action="letter_k.php" id="form" name="form" enctype="multipart/form-data">
	<?php
...
EOM;
	...
	echo <<<EOM
						...
						<h4>◆健康状態</h4>
						<p>体重：　<input type="text" name="kg" value="$kg" align="left" size="10" style="ime-mode: disabled;" maxlength="3">kg　　
