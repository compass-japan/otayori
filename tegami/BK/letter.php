...
<body>
	<form method="post" action="" id="form" name="form" enctype="multipart/form-data">
		...
		<div class="bt">
			<input type="image" src="img/finish_preview.png" width="150" name="send" id="form1" onclick="return goServletB();">
			<input type="image" src="img/finish_unfinished.png" width="150" name="send" id="form2" onclick="goServletC();">
